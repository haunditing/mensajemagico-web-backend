  ...
  subscription_plans: {
    ...
    premium: {
      ...
      pricing_hooks: {
        ...
        mercadopago_price_yearly_usd_original: process.env.MERCADOPAGO_PRICE_YEARLY_USD_ORIGINAL ? Number(process.env.MERCADOPAGO_PRICE_YEARLY_USD_ORIGINAL) : undefined,
      },
    },
  },
